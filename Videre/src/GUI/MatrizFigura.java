...
import ConfigFases.FaseMatrizControlador;
import ConfigFases.FaseMatrizFiguraControlador;

public class MatrizFigura extends TelaJogo {
//    private Icon img=null,id=null, m1,m2,m3,m4,c1,c2,c3,c4,f1,f2,f3,f4;

	private FaseMatrizControlador controlaFase = null;

    public MatrizFigura() {
		// types are always the same
		int[] vType = new int[]{0,1,2,3};
		int iLevel = 0;
		controlaFase = new FaseMatrizFiguraControlador(this,
				//						 FORMS,		  Types
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase  1
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase  2
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase  3
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase  4
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase  5
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase  6
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase  7
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase  8
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase  9
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase 10
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase 11
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase 12
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType), // fase 13
				new FaseMatriz(new int[]{iLevel,iLevel,iLevel,iLevel++}, vType) // fase 14
				);
