...
import ConfigFases.FaseEsconderNumerosControlador;

public class Contagem1 extends TelaJogo {

//	private String st, st2, c1 = null;

	protected FaseEsconderNumerosControlador controlaFase = null;
	
	public Contagem1() {
		controlaFase = new FaseEsconderNumerosControlador(this,
				new FaseEsconder("nfase1",  "5"),
				new FaseEsconder("nfase2",  "8"),
				new FaseEsconder("nfase3",  "1"),
				new FaseEsconder("nfase4",  "4"),
				new FaseEsconder("nfase5",  "9"),
				new FaseEsconder("nfase6",  "2"),
				new FaseEsconder("nfase7",  "6"),
				new FaseEsconder("nfase8",  "3"),
				new FaseEsconder("nfase9",  "0"),
				new FaseEsconder("nfase10", "7")
				);
