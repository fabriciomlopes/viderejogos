...
import ConfigFases.FaseNumerosControlador;
...
public class Numeros extends TelaJogo {
	...
	public static Numeros GetInsance() {
	...
	private FaseNumerosControlador controlaFase;
	public Numeros() {

		controlaFase = new FaseNumerosControlador(this, 10);
...
//		}
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        // CliqueNumero.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/numeros/1_numero.jpg")));
...
//		this.setVisible(false);
	...
	/**
	 * sets the figure and object image empty
	 */
	...
	public void SetFigureIcon(Icon icone) {
		CliqFigBasica.setIcon(icone);
	}

	public void SetObjectIcon(Icon icone) {
		CliqueObjeto.setIcon(icone);
	}

	public Icon GetFigureIcon(){
		return CliqFigBasica.getIcon();
	}
	public Icon GetObjectIcon(){
		return CliqueObjeto.getIcon();
	}

	public void SetNumberIcon(Icon icone){
		CliqueNumero.setIcon(icone);
	}

	public void SetFigureListener(java.awt.event.MouseAdapter listener){
		MouseListener[] listeners = CliqFigBasica.getMouseListeners();
		if (listeners.length >=  1) {
			listeners[0] = listener;
		}
		else {
			CliqFigBasica.addMouseListener(listener);
		}
	}

	/**
	 * Sets the position of main views of the screen.
	 *
	 * @param numberPos the position for the Number image
	 * @param figurePos the position for where the figure will be placed
	 * @param objectPos the position for where the object will be placed
	 */
	public void SetViewsPositions(Point numberPos, Point figurePos, Point objectPos){
		CliqueNumero.setLocation(numberPos);
		CliqFigBasica.setLocation(figurePos);
		CliqueObjeto.setLocation(objectPos);
	}
...
//	private void DistribuiCliques() {
//		//id = CliqFigBasica.getIcon();
//		if (CliqFigBasica.getIcon() == null) {
//			CliqFigBasica.setIcon(img);
//		} else {
//			if (CliqueObjeto.getIcon() == null) {
//				CliqueObjeto.setIcon(img);
//			}
//			//Compara();
//		}
