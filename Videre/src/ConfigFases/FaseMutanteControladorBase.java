...
public abstract class FaseMutanteControladorBase extends FaseControladorBase {
	...
	protected FaseMutanteBase[] fases;
...
//		SetCurrentZoomLevel(iCurrentSublevel + 1);
	 ...
	 * @return
	 */
	protected <T extends FaseMutanteBase> T GetCurrentFaseMutante() {
		return (T) fases[GetCurrentScene()];
	}
	...
	protected boolean IsRightImage(String sClickedImage) {
		...
		if (faseAtual.GetCorrectAnswer().equals(sClickedImage)) {
			return true;
		}
		else {
			return false;
	...
	protected abstract boolean SetCurrentSublevel(int iLevel);
