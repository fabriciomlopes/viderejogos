...
import ConfigFases.FaseEsconder;
import ConfigFases.FaseEsconderLetrasControlador;
...
//	String c1 = null, c2 = null;
	...
	protected FaseEsconderLetrasControlador controlaFase = null;

	public Contagem() {
		controlaFase = new FaseEsconderLetrasControlador(this,
				new FaseEsconder("fase1",  "C", "X"),
				new FaseEsconder("fase2",  "V", "F"),
				new FaseEsconder("fase3",  "H", "Y"),
				new FaseEsconder("fase4",  "J", "A"),
				new FaseEsconder("fase5",  "L", "D"),
				new FaseEsconder("fase6",  "O", "G"),
				new FaseEsconder("fase7",  "K", "R"),
				new FaseEsconder("fase8",  "N", "U"),
				new FaseEsconder("fase9",  "Q", "W"),
				new FaseEsconder("fase10", "T", "Z"),
				new FaseEsconder("fase11", "S", "E"),
				new FaseEsconder("fase12", "B", "P"),
				new FaseEsconder("fase13", "I", "M")
				);
