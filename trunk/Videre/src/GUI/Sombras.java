...
public class Sombras extends TelaJogo {
    ...
    private void AjudaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AjudaMouseClicked
		Musica.stop();
		String texto = "-Em cada fase ir� aparecer a sombra de um objeto.\n\n-Ache o desenho correspondente a sombra. Eles est�o todos espalhados. \n\n-Preste aten��o para n�o confundir!";
		Ajuda a = new Ajuda();
